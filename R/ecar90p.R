...
#' percentage of wet days with RR \> RRn90 is calculated. RRn90 is calculated as
#' the 90th percentile of all wet days of a given climate reference period.
#' Usually infile2 is generated by the operator ydaypctl,90. The date information
...
#' @rdname EcaR90p
#' @export
cdo_eca_r90p <- function(infile1, infile2, outfile = NULL) {
  .new_step(operator = 'eca_r90p', 
            inputs = list(infile1), 
            outputs = c(outfile), 
            n_inputs = 2,
            n_outputs = 1)
