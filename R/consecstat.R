...
#' 
#' This module computes periods over all timesteps in infile where a certain
#' property is valid. The property can be chosen by creating a mask from the
#' original data, which is the expected input format for operators of this module.
#' Depending on the operator full information about each period or just its length
#' and ending date are computed.
#' 
#' @details
