...
#' 
#' This module writes information about the structure and contents for each field
#' of all input files to standard output. A field is a horizontal layer of a data
#' variable. All input files need to have the same structure with the same
#' variables on different timesteps. The information displayed depends on the
#' chosen operator.
#' 
#' @details
