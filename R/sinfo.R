...
#' Short information
#' 
#' This module writes information about the structure of infiles to standard
#' output. infiles is an arbitrary number of input files. All input files need to
#' have the same structure with the same variables on different timesteps. The
